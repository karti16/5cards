  ...
  return (
    <div className="flex flex-col min-h-screen justify-center items-center p-6">
      <h1 className="pb-10 text-[30px]">
        {" "}
        🖐 <span className="text-green-500">5 cards test</span>{" "}
      </h1>
      <Input
      ...
      {!!notValidGroupId && (
        <p className="text-red-300 text-sm pt-2">
          An alphanumeric word with 🖐 5 characters
        </p>
      )}
      {!!isGroupExist && (
        <p className="text-red-500 text-sm pt-2">Group not found</p>
      )}
      <div className="card flex gap-2">
        ...
        <Button
          ...
          className="focus:ring-2 focus:ring-green-800 bg-green-600"
        >
          New group
        </Button>
      </div>
      <div className="text-sm text-gray-500">
        <p>
          <span className="text-green-500">Record points</span> for the 5 card
          game
        </p>
        <p>--✵--</p>
